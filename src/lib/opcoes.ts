export const SOTAQUES = [
  ...
  { valor: "sudeste-mineiro-sul-triangulo", rotulo: "Mineiro - Sul / Triângulo", regiao: "sudeste" },
  ...
  { valor: "sul-paranaense-norte", rotulo: "Paranaense - Norte / caipira paranaense", regiao: "sul" },
